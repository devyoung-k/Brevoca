...
export function ExportDocxDialog({
    ...
    const [dateTime, setDateTime] = useState(() =>
        formatDefaultDateTime(meeting.createdAt),
    );
    ...
    useEffect(() => {
        ...
        setAuthor("");
        setLocation("");
        setDateTime(formatDefaultDateTime(meeting.createdAt));
        setAttendees([{ ...EMPTY_ATTENDEE }]);
        setExporting(false);
    }, [meeting.createdAt, meeting.id, open]);
        ...
        try {
            const exportData: DocxExportData = {
                ...
                attendees: attendees.filter(
                    (a) => a.name || a.department || a.position,
                ),
            };
