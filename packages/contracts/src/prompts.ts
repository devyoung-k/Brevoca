...
- 각 토픽의 points에는 해당 안건에서 오간 핵심 발언, 배경, 우려사항, 검토 포인트를 '●' 불릿으로 옮길 수 있게 완결된 문장으로 넣는다.
- "회의 결론"에는 최종 합의, 결정 방향, 후속 검토 필요사항을 번호 목록으로 옮길 수 있게 정리한다.
- nextSteps에는 실제 담당/기한 추적이 필요한 실행 항목만 넣는다.
...
- 각 토픽의 points에는 해당 안건에서 나온 현황, 문제점, 부서별 의견 차이, 검토 포인트, 개선 방향을 '●' 불릿으로 바로 옮길 수 있게 완결된 문장으로 넣는다.
- "회의 결론"에는 합의된 방향, 추가 검토 필요사항, 다음 회의 전 준비사항을 번호 목록으로 옮길 수 있게 정리한다.
- nextSteps에는 실제 담당/기한 추적이 필요한 실행 항목만 넣는다.
